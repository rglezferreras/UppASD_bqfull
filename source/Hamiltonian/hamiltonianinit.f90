...
contains
   ...
   subroutine setup_hamiltonian(NT,NA,N1,N2,N3,Nchmax,do_ralloy,Natom_full,         &
      ...
      use HamiltonianData, only : allocate_hamiltoniandata, allocate_anisotropies,  &
         ...
         allocate_bqfull11data, allocate_bqfull21data, allocate_bqfull22data, allocate_bqfull23data , &
         allocate_bqfull31data, allocate_bqfull32data, allocate_bqfull33data, allocate_bqfull34data, allocate_bqfull35data, allocate_bqfull36data
      ...
      if(ham_inp%do_bqfull23==1) then
		 write (*,'(2x,a)',advance='no') 'Set up neighbour map for 4spin-2site Biquadratic exchange H23'
         ! Allocate and mount DM Hamiltonian
         call setup_nm(Natom,NT,NA,N1,N2,N3,C1,C2,C3,BC1,BC2,BC3,block_size,atype,  &
         ...
         ! Transform data to general structure
         write (*,'(2x,a)',advance='no') 'Mount 4spin-2site Biquadratic Interaction Hamiltonian H23'
         call setup_neighbour_hamiltonian(Natom,conf_num,NT,NA,nHam,anumb,atype,    &
      ...
      if(ham_inp%do_bqfull34==1) then
         !Mount the 4spin-2site biquadratic terms
         write (*,'(2x,a)',advance='no') 'Set up neighbour map for 4spin-2site Biquadratic exchange H34'
         call setup_nm(Natom,NT,NA,N1,N2,N3,C1,C2,C3,BC1,BC2,BC3,block_size,atype,  &
         ...
         ! Transform data to general structure
         write (*,'(2x,a)',advance='no') 'Mount 4spin-2site Biquadratic Interaction Hamiltonian H34'
         call setup_neighbour_hamiltonian(Natom,conf_num,NT,NA,nHam,anumb,atype,    &
